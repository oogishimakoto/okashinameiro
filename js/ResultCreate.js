...
function result_create() {
  ...
  // Scoreボード表示
  this.add.image(width / 2, height / 2, 'gameover');
  ScoreBoard = this.add.text(width / 3.3, height / 4.0, 'ScoreBoard').setFontSize(60).setFontFamily("fantasy").setOrigin(0, 0.5).setStyle({ color: '#000' });
